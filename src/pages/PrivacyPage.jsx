    ...
    <div className="min-h-screen bg-gray-50 py-12 px-4">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="prose prose-sm text-gray-700 space-y-6">
          <section>
            <h2 className="text-base font-semibold text-gray-900 mb-2">The Short Version</h2>
          ...
          <section>
            <h2 className="text-base font-semibold text-gray-900 mb-2">1. No Data Collection</h2>
            <p>
          ...
          <section>
            <h2 className="text-base font-semibold text-gray-900 mb-2">2. Local Storage</h2>
            <p>
              Your CV data is saved in your browser's <code className="bg-gray-100 px-1 rounded text-xs">localStorage</code>
              under the key <code className="bg-gray-100 px-1 rounded text-xs">cv_maker_data</code>.
          ...
          <section>
            <h2 className="text-base font-semibold text-gray-900 mb-2">3. No Cookies</h2>
            <p>
              We do not set any cookies. <code className="bg-gray-100 px-1 rounded text-xs">localStorage</code> is
          ...
          <section>
            <h2 className="text-base font-semibold text-gray-900 mb-2">4. Analytics</h2>
            <p>
              ...
              See <a href="https://www.cloudflare.com/privacypolicy/" className="underline hover:text-gray-900" target="_blank" rel="noopener noreferrer">Cloudflare's privacy policy</a> for details.
            </p>
          </section>

          <section>
            <h2 className="text-base font-semibold text-gray-900 mb-2">5. How to Delete Your Data</h2>
            ...
            <ul className="list-disc pl-5 mt-2 space-y-1">
              ...
              <li>
                ...
                select this site → delete the <code className="bg-gray-100 px-1 rounded text-xs">cv_maker_data</code> key.
              </li>
              <li>

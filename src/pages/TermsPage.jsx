    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 py-12 px-4">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="prose prose-sm text-gray-700 dark:text-gray-300 space-y-6">
          <section>
            <h2 className="text-base font-semibold text-gray-900 dark:text-gray-100 mb-2">1. About This Service</h2>
            <p>
          ...
          <section>
            <h2 className="text-base font-semibold text-gray-900 dark:text-gray-100 mb-2">2. Your Data</h2>
            <p>
              All CV data you enter is stored exclusively in your browser's <code className="bg-gray-100 dark:bg-gray-700 dark:text-gray-200 px-1 rounded text-xs">localStorage</code>.
          ...
          <section>
            <h2 className="text-base font-semibold text-gray-900 dark:text-gray-100 mb-2">3. No Warranty</h2>
            <p>
          ...
          <section>
            <h2 className="text-base font-semibold text-gray-900 dark:text-gray-100 mb-2">4. Acceptable Use</h2>
            <p>
          ...
          <section>
            <h2 className="text-base font-semibold text-gray-900 dark:text-gray-100 mb-2">6. Changes to Terms</h2>
            <p>
